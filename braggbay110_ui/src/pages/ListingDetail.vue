						...
						<td style="width: 100%;"></td>
				        	...
				        	<td style="width: 150px;">
								...
								<div >
								  ...
								  <base-input label="ListingDate" type="text" placeholder="Enter ListingDate" v-model="listingToAdd.listingDate"></base-input>
								  <base-input label="Quantity" type="text" placeholder="Enter Quantity" v-model="listingToAdd.quantity"></base-input>
												                  </form>
								                </div>
            ...
            <div style="text-align: center; padding: 20px;">
              ...
              <button @click="handlePermissionDialogClose">OK</button>
					...
					<td class="detail_view_column_2">Listing Date</td>
										    <td class="detail_view_column_1">
							<div class="detail_view_input" style="display: inline-flex;">
																		<datepicker v-model="listingDetails.listingDate"  placeholder="Select Date" ></datepicker>
																		</div>
						</td>
														</tr>
															<tr> 
					<td class="detail_view_column_2">Quantity</td>
										    <td class="detail_view_column_1">
							<div class="detail_view_input" style="display: inline-flex;">
																		<input label="Quantity" type="text" placeholder="Enter Quantity" v-model="listingDetails.quantity"></input>
																		</div>
						</td>
														</tr>
